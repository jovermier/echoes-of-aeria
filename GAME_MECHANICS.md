...
if (spacebar && hasSword && !attacking && currentTime - lastAttackTime >= attackCooldown) {
  attacking = true;
  attackTimer = 0.3;
}
```
...
- **Oscillator Type**: Square wave for authentic SNES quality sound
